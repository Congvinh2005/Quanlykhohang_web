            ...
            <div class="pagination">
                ...
                <div class="pagination-controls">
                    <?php if ($data['current_page'] > 1): ?>
                        <a href="http://localhost/QLSP/Khachhang/orders/<?php echo $data['current_page'] - 1; ?>"
                    ...
                    if ($start_page > 1): ?>
                        <a href="http://localhost/QLSP/Khachhang/orders/1" class="btn-page">1</a>
                        <?php if ($start_page > 2): ?>
                    ...
                    <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <a href="http://localhost/QLSP/Khachhang/orders/<?php echo $i; ?>"
                    ...
                    <?php if ($end_page < $data['total_pages']): ?>
                        <?php if ($end_page < $data['total_pages'] - 1): ?>
                            <span class="ellipsis">...</span>
                        <?php endif; ?>
                        <a href="http://localhost/QLSP/Khachhang/orders/<?php echo $data['total_pages']; ?>"

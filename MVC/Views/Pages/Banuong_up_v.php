    ...
    <div class="card">
        <div class="actions-top">
            <div>
                ...
                <p class="lead">Nhập danh sách bàn uống từ file Excel.</p>
            </div>
            <div class="actions">
                <a href="http://localhost/QLSP/Banuong/danhsach" class="btn-ghost"><i
                        class="fa-solid fa-list"></i> Danh sách</a>
                <a href="http://localhost/QLSP/Banuong/template" class="btn-excel"><i
                        class="fa-solid fa-download"></i> Tải mẫu</a>
            </div>
        </div>

        <form method="post" action="http://localhost/QLSP/Banuong/up_l" class="form-search"

            ...
            <table>
                ...
                <tbody id="dmBody">
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/QLSP/Banuong/order/<?php echo urlencode($row['ma_ban']) ?>"
                                style="color: inherit; text-decoration: none; font-weight: 500;"><?php echo htmlspecialchars($row['ten_ban']) ?></a>
                        </td>

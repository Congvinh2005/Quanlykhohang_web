...
<body>
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data" action="?url=Nhacungcap/import">
            <label>Chọn file Excel (.xlsx)</label>
            <input type="file" name="file" accept=".xlsx,.xls" required>
            <div class="actions">
                <button type="submit">Tải lên và nhập</button>
                <a href="?url=Nhacungcap/export" style="text-decoration:none"><button type="button">Xuất danh
                        sách</button></a>
                <a href="?url=Nhacungcap/template" style="text-decoration:none"><button type="button">Tải mẫu
                        Excel</button></a>
            </div>
        </form>
    </div>

...
<body>
    ...
    * {
    ...
    /* Cột 2, 3, 4: Mã ĐH, Bàn, User - Căn trái mặc định */
    th:nth-child(2),
    td:nth-child(2) {
        width: 8%;
    }
    ...
    <div class="card">
        ...
        <form method="post" action="http://localhost/QLSP/Donhang/Timkiem" class="form-search"
            ...
            <div class="search-fields">
                ...
                <!-- <div>
                    <label for="searchName">Thanh toán</label>
                    <input type="text" id="searchName" name="txtThanhtoan" placeholder="Nhập thanh toán..."
                        value="<?php echo isset($data['thanh_toan']) ? htmlspecialchars($data['thanh_toan']) : ''; ?>" />
                </div> -->
            </div>
                ...
                <tbody id="dhBody">
                    ...
                    <tr>
                        ...
                        <td><span
                                ...
                                ₫</span></td>
                        <td>
                            <?php echo number_format($row['thanh_toan'], 0, '.', '.') . 'đ'; ?>
                        </td>
                        <td>
                            <!-- <span
                                ...
                                <?php echo $row['trang_thai_thanh_toan'] == 'chua_thanh_toan' ? 'chua_thanh_toan' : 'da_thanh_toan'; ?>
                            </span> -->
                            <span
                                style="background:<?php echo $row['trang_thai_thanh_toan'] == 'chua_thanh_toan' ? '#fed7aa' : '#d1fae5'; ?>;color:<?php echo $row['trang_thai_thanh_toan'] == 'chua_thanh_toan' ? '#c2410c' : '#065f46'; ?>;padding:4px 8px;border-radius:6px;font-size:12px;font-weight:600">
                                <?php echo $row['trang_thai_thanh_toan'] == 'chua_thanh_toan' ? 'Not' : 'Paid'; ?>
                            </span>

    ...
    <div class="wrap">
        <div class="card">
            <div style="text-align: center; margin-bottom: 30px;">
                <h2><i class="fa-solid fa-cloud-arrow-up"></i> Tải lên file Sản phẩm</h2>
                <p class="hint">Sử dụng form dưới đây để tải lên file Sản phẩm.</p>
            </div>

            <form method="POST" action="http://localhost/QLSP/Sanpham/up_l" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    <a href="http://localhost/QLSP/Sanpham/danhsach" class="btn btn-secondary">

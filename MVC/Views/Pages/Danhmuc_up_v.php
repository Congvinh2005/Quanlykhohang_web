...
<body>
    <div class="wrap">
        <div class="card">
            ...
            <form method="POST" action="http://localhost/QLSP/Danhmuc/up_l" enctype="multipart/form-data">
                ...
                <div class="form-actions">
                    <a href="http://localhost/QLSP/Danhmuc/danhsach" class="btn btn-secondary">

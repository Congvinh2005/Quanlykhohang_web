    ...
    * {
    ...
    <div class="card">
        <div class="actions-top">
            <div>
                <h1><i class="fa-solid fa-chair"></i> Cập nhật Bàn Uống</h1>
                <p class="lead">Cập nhật thông tin bàn uống.</p>
            </div>
            <div class="actions">
        ...
        <form method="post" action="http://localhost/QLSP/Banuong/update" class="form-search"
            ...
            <div>
                ...
                <input type="text" id="txtMaban" name="txtMaban" placeholder="Nhập mã bàn..."
                    value="<?php echo htmlspecialchars($data['ma_ban']); ?>" readonly />
            </div>
            <div>
                <label for="txtTenban">Tên bàn</label>
                <input type="text" id="txtTenban" name="txtTenban" placeholder="Nhập tên bàn..."
                    value="<?php echo htmlspecialchars($data['ten_ban']); ?>" />
            </div>
            <div>
                <label for="txtSochongoi">Số chỗ ngồi</label>
                <input type="number" id="txtSochongoi" name="txtSochongoi" placeholder="Nhập số chỗ ngồi..."
                    value="<?php echo htmlspecialchars($data['so_cho_ngoi']); ?>" />
            </div>
            <div>
                <label for="txtTrangthai">Trạng thái bàn</label>
                <select id="txtTrangthai" name="txtTrangthai">
                    <option value="trong" <?php echo ($data['trang_thai_ban'] == 'trong') ? 'selected' : ''; ?>>Trống</option>
                    <option value="dang_su_dung" <?php echo ($data['trang_thai_ban'] == 'dang_su_dung') ? 'selected' : ''; ?>>Đang sử dụng</option>
                </select>
            </div>
